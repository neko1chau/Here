...
extension AddTimezone {
    ...
    func saveEntry() {
        let entryId = Int64.random(in: 1 ... 99999)

        if let localImage = image, showingLocalUpload {
            _ = Utils.saveLocalAvatar(entryId: entryId, image: localImage)
        }
